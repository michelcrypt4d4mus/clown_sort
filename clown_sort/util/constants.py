...
DEFAULT_SCREENSHOTS_DIR = Path(environ.get('SCREENSHOTS_DIR', _DEFAULT_SCREENSHOTS_DIR))
DEFAULT_DESTINATION_DIR = Path(environ.get('DESTINATION_DIR', _DEFAULT_SCREENSHOTS_DIR))
